...
namespace AerialRace
{
    static class BuiltIn
    {
        ...
        static BuiltIn()
        {
            ...
            GrayTex = RenderDataUtil.Create1PixelTexture("BuiltIn.White", new Color4(0.18f, 0.18f, 0.18f, 1f));
            GrayTransparentTex = RenderDataUtil.Create1PixelTexture("BuiltIn.WhiteTransparent", new Color4(0.18f, 0.18f, 0.18f, 0f));
